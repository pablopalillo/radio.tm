...
define("LM_MSG_BACK_11","Все сделано! Руководство процессом резервного копирования закончено! <a href='plugins.php?page=xcloner_show&?option=com_cloner&task=view'>Нажмите здесь, чтобы продолжить</a>");
...
<pre>
  ...
  С помощью функций копирования 'CLONE' - <a href='plugins.php?page=xcloner_show&?option=com_cloner&task=view'>Просмотр резервных копий</a>,
...
----------------------------------------------------------------------------------
   <b>Шаг 1 - Копирование резервной копии сайта на хостинг</b>
    ...
    - перейдите в меню XCloner -> <a href='plugins.php?page=xcloner_show&?option=com_cloner&task=view'>Просмотр резервных копий</a>
