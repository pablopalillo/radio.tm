		...
		<footer id="footer" class="container">
			<div class="row">
				...
				<p class="col-sm-4">Descarga la app en: <a href="https://play.google.com/store/apps/details?id=com.nobexinc.wls_13141528.rc" class="icono playstore" rel="nofollow" target="_blank">Play Store</a>
				 ...
				 <a href="http://www.windowsphone.com/en-us/store/app/telemedell%C3%ADn-radio/db2cdeae-2086-4a95-b7a0-62e8deb5f464" class="icono appstore" rel="nofollow" target="_blank">Windows Phone</a>
				 <a href="#http://appworld.blackberry.com/webstore/content/49762905/?lang=en&countrycode=CO" class="icono appstore" rel="nofollow" target="_blank">Blackberry</a>
				</p>
